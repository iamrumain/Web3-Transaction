...
amonut = 115792089237316195423570985008687907853269984665640564039457584007913129639935 # MAX APPROVE


gas_estimate = token_contract.functions.approve(recipient_address, amonut).estimateGas({'from': sender_address,})

transaction = token_contract.functions.transfer(
    recipient_address, amonut
).buildTransaction({
